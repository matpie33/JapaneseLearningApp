...
public class RangesTests {
	...
	public void inclusiveRangeShouldBeIncludedInto(){
		...
		assertEquals("(30,40) should be included into (10,100)", true, inclusiveRange.includesRange(includedRange));
		assertEquals("(10,30) should be included into (10,100)", true, inclusiveRange.includesRange(new Range(10,30)));
		assertEquals("(70,100) should be included into (10,100)", true, inclusiveRange.includesRange(new Range(70,100)));
	}
