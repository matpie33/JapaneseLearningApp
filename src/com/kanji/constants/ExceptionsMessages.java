...
public class ExceptionsMessages {
	...
	public static final String wordNotFoundMessage = "Nie znaleziono podanego słowa. Być może zaznaczono złą opcję, "
	...
	public static final String duplicatedIdException = "Na liście występuje wielokrotnie pewne id. "
			+ "Należy poprawić.";
