...
public enum PartOfSpeech {
	...
	VERB ("Czasownik"), NOUN ("rzeczownik"), I_ADJECTIVE ("i-przymiotnik"),
	NA_ADJECTIVE ("na-przymiotnik"), EXPRESSION ("Wyrażenie");
	...
	public static PartOfSpeech getPartOfSpeachByPolishMeaning (String polishMeaning){
		...
		throw new RuntimeException("Could not find part of speech by polish meaning: "+polishMeaning);
	}
