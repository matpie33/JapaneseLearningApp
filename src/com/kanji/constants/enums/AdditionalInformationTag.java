...
public enum AdditionalInformationTag {
	...
	ALTERNATIVE_KANJI_WRITING (Labels.ALTERNATIVE_KANJI_WRITING),
	ALTERNATIVE_KANA_WRTING (Labels.ALTERNATIVE_KANA_WRITING),
	VERB_CONJUGATION (Labels.VERB_CONJUGATION),
	TAKING_PARTICLE (Labels.TAKING_PARTICLE);
